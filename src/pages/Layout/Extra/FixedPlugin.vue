  ...
  data() {
    return {
      ...
      sidebarImages: [
        ...
        { image: require("@/assets/img/dark-grey-1.jpg"), active : false},
        { image: require("@/assets/img/light-grey-1.jpg"), active : true},
        { image: require("@/assets/img/white.png"), active : false}
      ]
    };
  },
  methods: {
